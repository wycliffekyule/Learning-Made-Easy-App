...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <h3 className="text-lg font-semibold text-gray-900 mb-4">New to Learning Made Easy?</h3>
        <p className="text-gray-600 mb-4">
          Watch this quick demo to learn how to make the most of your learning experience.
        </p>
        <DemoVideo className="max-w-md" />
      </motion.div>
    </div>
  );
};
